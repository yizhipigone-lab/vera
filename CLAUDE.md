...
| 影子校尺 | `trade/shadow.py` + `tools/shadow_compare.py` | 2026-08-23 P0(源自当日 MA20vs动量研判):旧 MA20 三态(`rotation.compute_signal`,deprecated 未删)作影子策略,`_worker` 每日落盘 `data/shadow_rotation.jsonl`(**只记录不交易**,fail-soft 绝不影响交易链);对比工具 TDX→新浪降级取数,同尺重放两套规则算季度滚动 90 日收益,**影子连续 2 季赢动量超 10pp → 提示人工复审换规则**。首次实跑(2026-08-23)即触发:影子连 3 季跑赢(2026Q1-Q3,差 +15/+14/+30pp),待人工复审 |
