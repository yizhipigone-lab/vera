...
CHUNKS = [
    ("20200101", "20230101"), ("20230101", "20250101"), ("20250101", "20260801"),
]

MAXBUY = float(os.environ.get("MAXBUY", "20000"))
TAG = "hhtp2020_5m_chain_" + os.environ.get("SUFFIX", "mb2w")
...
sel_all = pd.read_parquet(f"{OUT}/server_hhtp_2020_2026.parquet")
