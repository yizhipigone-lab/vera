...
| 参数 | 必填 | 类型 | 说明 |
|------|------|------|------|
| stock_code | N | str | down_type=1 时为 A 股代码; down_type=2 时为 ETF 代码; down_type=3,4 时无效 |
| down_time | N | str | down_type=1 时为年份 (`YYYY`); down_type=2 时为日期 (`YYYYMMDD`); down_type=3,4 时无效 |
