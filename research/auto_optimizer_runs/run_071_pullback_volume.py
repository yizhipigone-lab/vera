...
def main():
    ...
    sig = f_pullback_volume(close, high=high, low=low, vol=vol, **{"fast": 10, "slow": 60, "k": 1.3})
    selections = signals_to_selections(sig, "回踩+放量")
