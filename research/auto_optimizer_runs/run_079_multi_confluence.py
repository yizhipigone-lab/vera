# -*- coding: utf-8 -*-
"""自动寻优第 79 轮策略 (self-contained, 可独立运行): 多因子共振
生成时间: 2026-08-11 08:43
因子: multi_confluence  入场参数: {"fast": 5, "slow": 20, "trend": 60, "k": 1.3, "rsi_n": 14, "rsi_hi": 70}
出场: 硬止损=-0.1 移动止盈激活=0.08/回撤=0.03 (条件单语义) 时间=20天 阶梯=None
仓位: 最多持 10 只, 单票 5000~30000元
手续费/滑点: 0.0003 / 0.001
区间: 20190101 ~ 20260731  股票池: hs300 (type=23, 剔除ST)
绩效: 年化=8.35% 回撤=-13.37% 夏普=0.69 交易=3007 胜率=54.4%
...
def main():
    ...
    sig = f_multi_confluence(close, high=high, low=low, vol=vol, **{"fast": 5, "slow": 20, "trend": 60, "k": 1.3, "rsi_n": 14, "rsi_hi": 70})
    selections = signals_to_selections(sig, "多因子共振")
