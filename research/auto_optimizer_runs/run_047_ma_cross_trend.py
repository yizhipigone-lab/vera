...
def main():
    ...
    sig = f_ma_cross_trend(close, high=high, low=low, vol=vol, **{"fast": 5, "slow": 20, "trend": 60})
    selections = signals_to_selections(sig, "金叉+趋势60")
