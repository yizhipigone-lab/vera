# -*- coding: utf-8 -*-
"""自动寻优第 79 轮策略 (self-contained, 可独立运行): 低波突破
生成时间: 2026-08-11 07:23
因子: lowvol_breakout  入场参数: {"n": 20, "q": 0.3}
出场: 硬止损=-0.1 移动止盈激活=0.08/回撤=0.03 (条件单语义) 时间=20天 阶梯=None
仓位: 最多持 10 只, 单票 5000~30000元
手续费/滑点: 0.0003 / 0.001
区间: 20190101 ~ 20260731  股票池: hs300 (type=23, 剔除ST)
绩效: 年化=4.24% 回撤=-23.10% 夏普=0.25 交易=11108 胜率=82.1%
...
def main():
    ...
    sig = f_lowvol_breakout(close, high=high, low=low, vol=vol, **{"n": 20, "q": 0.3})
    selections = signals_to_selections(sig, "低波突破")
