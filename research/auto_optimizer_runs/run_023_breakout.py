# -*- coding: utf-8 -*-
"""自动寻优第 23 轮策略 (self-contained, 可独立运行): 突破20日
生成时间: 2026-08-11 07:07
因子: breakout  入场参数: {"n": 20}
出场: 硬止损=-0.1 移动止盈激活=0.08/回撤=0.03 (条件单语义) 时间=20天 阶梯=None
仓位: 最多持 10 只, 单票 5000~30000元
手续费/滑点: 0.0003 / 0.001
区间: 20190101 ~ 20260731  股票池: hs300 (type=23, 剔除ST)
绩效: 年化=2.75% 回撤=-44.29% 夏普=0.16 交易=22918 胜率=80.3%
...
def main():
    ...
    sig = f_breakout(close, high=high, low=low, vol=vol, **{"n": 20})
    selections = signals_to_selections(sig, "突破20日")
