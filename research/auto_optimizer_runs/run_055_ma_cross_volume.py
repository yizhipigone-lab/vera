...
def main():
    ...
    sig = f_ma_cross_volume(close, high=high, low=low, vol=vol, **{"fast": 5, "slow": 20, "k": 1.5})
    selections = signals_to_selections(sig, "金叉+放量")
