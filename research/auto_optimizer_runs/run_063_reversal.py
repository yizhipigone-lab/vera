# -*- coding: utf-8 -*-
"""自动寻优第 63 轮策略 (self-contained, 可独立运行): 超跌反弹
生成时间: 2026-08-11 07:21
因子: reversal  入场参数: {"n": 10, "drop": -0.08}
出场: 硬止损=-0.1 移动止盈激活=0.08/回撤=0.03 (条件单语义) 时间=20天 阶梯=None
仓位: 最多持 10 只, 单票 5000~30000元
手续费/滑点: 0.0003 / 0.001
区间: 20190101 ~ 20260731  股票池: hs300 (type=23, 剔除ST)
绩效: 年化=12.50% 回撤=-33.12% 夏普=0.61 交易=18294 胜率=58.2%
...
def main():
    ...
    sig = f_reversal(close, high=high, low=low, vol=vol, **{"n": 10, "drop": -0.08})
    selections = signals_to_selections(sig, "超跌反弹")
