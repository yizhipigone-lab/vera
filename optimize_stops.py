"""止盈止损参数网格搜索 — QUANTQQ 2026.1.1~2026.5.28"""
...
LADDER_GRID = [
    ...
    ([{'profit': 0.02, 'sell_ratio': 1.0}], "2%→100%"),
    ([{'profit': 0.02, 'sell_ratio': 0.50}, {'profit': 0.05, 'sell_ratio': 1.0}], "2%→50%,5%→100%"),
    ([{'profit': 0.01, 'sell_ratio': 0.30}, {'profit': 0.03, 'sell_ratio': 1.0}], "1%→30%,3%→100%"),
    ([{'profit': 0.03, 'sell_ratio': 0.50}, {'profit': 0.06, 'sell_ratio': 1.0}], "3%→50%,6%→100%"),
    ([{'profit': 0.02, 'sell_ratio': 0.30}, {'profit': 0.04, 'sell_ratio': 0.50}, {'profit': 0.06, 'sell_ratio': 1.0}], "2%→30%,4%→50%,6%→100%"),
]

COST_GRID = [-0.06, -0.08, -0.10]
